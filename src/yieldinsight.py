...
Renders the gross-rental-yield-by-municipality insight (a diverging horizontal
bar, the 3rd of the top-10 deck) into one self-contained, offline HTML file.

This script is fully standalone: it recomputes every figure from the scraped
listings with the model's market-bound cleaning rules and embeds the Plotly
runtime in the output, so nothing external is needed to build or view it.
